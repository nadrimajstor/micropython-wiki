...
1. Object finalization (``__del__()`` method) is not currently implemented. This is tracked by #245.
1. It's not possible to subclass builtin types. #317
...
1. print() function doesn't use Python stream infrastructure, but underlying C printf() function directly. This means if you override sys.stdout, print() won't be affected. #209
1. Some more advanced usages of package/module importing not fully implemented. #298
